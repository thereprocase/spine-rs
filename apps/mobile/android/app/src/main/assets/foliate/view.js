...
export class View extends HTMLElement {
    ...
    #createOverlayer({ doc, index }) {
        // SPINE-PATCH: paginator dispatches create-overlayer with doc=null when
        // the iframe contentDocument is missing (blob:→srcdoc race). Bail out
        // rather than crashing addEventListener on null. Tap-zone wiring lives
        // in spine-host's load handler, which has its own null guard.
        if (!doc) return null
